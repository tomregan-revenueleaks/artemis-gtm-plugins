...
The Artemis agent and bundle links (`artemisgtm.ai/agents/...`) are Artemis GTM's own products, not affiliate links — they're the build agents that fix the leaks this audit finds.
