...
Partner: Warmly — captures the inbound visitor/lead signal and fires the alert that
 ...
 Affiliate link: artemisgtm.ai/go/warmly. Artemis GTM earns commission if you
 sign up, at no extra cost to you. Recommended based on validation across 127+
 audits, not the commission.

 Amplemarket — runs the multi-channel sequenced follow-up once the lead is in.
 Affiliate link: artemisgtm.ai/go/amplemarket. (affiliate link; Artemis earns
 commission.)
...
The Speed-to-Lead agent link (`artemisgtm.ai/agents/speed-to-lead/`) is Artemis's own product, not an affiliate link — no commission disclosure needed, just be honest it's a paid agent.
