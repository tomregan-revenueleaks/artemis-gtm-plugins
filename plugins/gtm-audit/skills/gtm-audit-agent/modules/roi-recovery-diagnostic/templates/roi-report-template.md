...
|--------------|---------|----------|
| Lead-to-opp: signal-based qualification + enrichment | Amplemarket | `artemisgtm.ai/go/amplemarket` |
| Lead-to-opp: the CRM layer for scoring + MQL-to-SQL handoff | Attio | `artemisgtm.ai/go/attio` |
| Win rate: deal-risk + loss analysis (conversation intelligence) | Attention | `artemisgtm.ai/go/attention` |
