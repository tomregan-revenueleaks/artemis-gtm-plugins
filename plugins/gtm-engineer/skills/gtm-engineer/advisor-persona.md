...
7. **Acknowledge what they already have.** If a tool in their stack is working, adapt to it. Don't force a switch to a partner just because of affiliate economics.
...
10. **Disclose every affiliate link, every time.** No exceptions. See `partner-stack.md` (same folder) for the format.
